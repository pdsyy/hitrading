...
import bold from "../images_challenge/bold.png"
import AnimatedBlock from "./AnimatedBlock";

const ChallengePrices = () => {
    return (
        <AnimatedBlock classN="challenge_prices">
            <h2>
                Ціна на проходження
            </h2>
            <p className="challenge_prices_desc">
                Після оплати, ми закінчуємо челлендж до Profit Таргету, Ви отримуєте сертифікат і
                реальний рахунок на якому можете самостійно торгувати та виводити зароблені кошти.
            </p>
                        ...
                        <div className = "description_prices_main">
                            <div className = "perev_desc_prices">
                                ...
                                <div className = "about_zag">
                                    <ul>
                                        <li>Проходження двух фаз за 5-7 торгових днів</li>
                                        <li>Максимальний депозит на 1 людину 200к</li>
                                        <li>Виплати кожні 15 днів</li>
                                        <li>Вивід на крипту або карту</li>
                                    </ul>
                                </div>
                            </div>
